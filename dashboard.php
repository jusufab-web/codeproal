...
<nav class="navbar navbar-default navbar-expand-lg navbar-light">
	<div class="navbar-header d-flex col">
		<a class="navbar-brand" href="#">Dashboard<b><i class="fa fa-user-o"></i> <?php echo $_SESSION['username']; ?> </b></a>  		
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
		...
		<ul class="nav navbar-nav navbar-right ml-m2">
			<li class="nav-item dropdown">
				<a data-toggle="dropdown" class="nav-link dropdown-toggle" href="#"><i class="fa fa-user-o"></i> <?php echo $_SESSION['username']; ?> </a>
				
				<ul class="dropdown-menu">
					<li>
					<li><a href="logout.php" class="dropdown-item">LogOut</a></li>
					<li><a href="update.php" class="dropdown-item">Settings</a></li>
